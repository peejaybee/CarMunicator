...
public class ChooseMessage extends Activity implements View.OnClickListener, View.OnLongClickListener
{
    private int buttonID[] = {R.id.button1,R.id.button2,R.id.button3,R.id.button4,R.id.button5,R.id.button6};
