...
public class MessageDBHelper extends SQLiteOpenHelper
{
	...
	String[] cols = new String[] {Message._ID,Message.CAPTION,Message.TEXT};
	
	SQLiteDatabase db = getReadableDatabase();
	
	Cursor rs = db.query(TABLE_NAME,cols,strSelection,null,null,null,null);
	...
	Cursor rs = db.query(TABLE_NAME,cols,null,null,null,null,Message._ID);
